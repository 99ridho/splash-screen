...
public class ESRender implements Renderer {
	...
	private PrimitivesObject button_new, button_exit, button_highscore, button_about;
	...
	public ESRender(Context context) {
		...
		this.button_about = new PrimitivesObject();
		this.button_exit = new PrimitivesObject();
		this.button_highscore = new PrimitivesObject();
		this.button_new = new PrimitivesObject();
	...
	public void onDrawFrame(GL10 gl) {
		...
		*/
	    ...
	    gl.glPushMatrix();
	    	gl.glDisable(GL10.GL_LIGHTING);
		    	gl.glTranslatef(550.0f, 350.0f, 1.0f);
	    		gl.glScalef(160.0f, 60.0f, 1.0f);
	    		gl.glTranslatef(0.0f, 0.0f, -5.0f);
		    	button_new.draw_background(gl);
	    	gl.glEnable(GL10.GL_LIGHTING);
	    gl.glPopMatrix();
	    
	    gl.glPushMatrix();
	    	gl.glDisable(GL10.GL_LIGHTING);
		    	gl.glTranslatef(550.0f, 250.0f, 1.0f);
	    		gl.glScalef(160.0f, 60.0f, 1.0f);
	    		gl.glTranslatef(0.0f, 0.0f, -5.0f);
		    	button_highscore.draw_background(gl);
	    	gl.glEnable(GL10.GL_LIGHTING);
    	gl.glPopMatrix();
    
	    gl.glPushMatrix();
			gl.glDisable(GL10.GL_LIGHTING);
		    	gl.glTranslatef(550.0f, 180.0f, 1.0f);
				gl.glScalef(160.0f, 60.0f, 1.0f);
				gl.glTranslatef(0.0f, 0.0f, -5.0f);
		    	button_about.draw_background(gl);
			gl.glEnable(GL10.GL_LIGHTING);
		gl.glPopMatrix();

		gl.glPushMatrix();
			gl.glDisable(GL10.GL_LIGHTING);
				gl.glTranslatef(550.0f, 110.0f, 1.0f);
				gl.glScalef(160.0f, 60.0f, 1.0f);
				gl.glTranslatef(0.0f, 0.0f, -5.0f);
				button_exit.draw_background(gl);
			gl.glEnable(GL10.GL_LIGHTING);
		gl.glPopMatrix();
...
//			}
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		primobbg.loadBallTexture(gl, context, 7);
		primobflappy.loadBallTexture2(gl, context, 0);
		primobground.loadBallTexture(gl, context, 6);
		
		button_new.loadButtonTexture2(gl, context, 1);
		button_about.loadButtonTexture2(gl, context, 0);
		button_highscore.loadButtonTexture2(gl, context, 2);
		button_exit.loadButtonTexture2(gl, context, 3);
